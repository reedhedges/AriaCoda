...
Subclass mt400           ; specific type of robot
...
RobotLength 510.00000    ; length in mm of the whole robot
RobotLengthFront 255.00000 ; length in mm to the front of the robot (if this is
                         ; 0 (or non existent) this value will be set to half of
                         ; RobotLength)
RobotLengthRear 255.00000 ; length in mm to the rear of the robot (if this is 0
...
LaserAutoConnect true    ; Laser_1 exists and should be automatically connected
                         ; at startup.
LaserX 37                ; Location (in mm) of the laser in X (+ front, - back)
...
LaserIgnore -76--72 72-76 ; Angles (in deg) at which to ignore readings, +/1 one
...
LaserAutoConnect false   ; Laser_2 exists and should be automatically connected
                         ; at startup.
LaserX 200               ; Location (in mm) of the laser in X (+ front, - back)
                         ; relative to the robot's idealized center of rotation.
LaserY 0                 ; Location (in mm) of the laser in Y (+ left, - right)
                         ; relative to the robot's idealized center of rotation.
LaserTh 0.00000          ; range [-180, 180], Rotation (in deg) of the laser (+
...
LaserCumulativeBufferSize 0 ; Cumulative buffer size to use for the laser. 0 to
                         ; use the default.
LaserStartDegrees -120   ; Start angle (in deg) for the laser. This may be used
                         ; to constrain the angle. Fractional degrees are
                         ; permitted. Leave blank to use the default.
LaserEndDegrees 120      ; End angle (in deg) for the laser. This may be used to
                         ; constrain the angle. Fractional degreees are
                         ; permitted. Leave blank to use the default.
LaserDegreesChoice       ; Degrees choice for the laser. This may be used to
                         ; constrain the range. Leave blank to use the default.
