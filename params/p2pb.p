...
Subclass p2pb            ; specific type of robot
RobotRadius 300.00000    ; radius in mm
RobotDiagonal 120.00000  ; half-height to diagonal of octagon
RobotWidth 425.00000     ; width in mm
RobotLength 513.00000    ; length in mm of the whole robot
...
DistConvFactor 0.42400   ; multiplier to mm from robot units
VelConvFactor 1.00000    ; multiplier to mm/sec from robot units
RangeConvFactor 0.26800  ; multiplier to mm from sonar units
...
SonarNum 24              ; Number of sonars on the robot.
...
SonarUnit 8 -20 136 90
SonarUnit 9 24 119 50
SonarUnit 10 58 78 30
SonarUnit 11 77 27 10
SonarUnit 12 77 -27 -10
SonarUnit 13 58 -78 -30
SonarUnit 14 24 -119 -50
SonarUnit 15 -20 -136 -90
SonarUnit 16 -157 -136 -90
SonarUnit 17 -203 -119 -130
SonarUnit 18 -237 -78 -150
SonarUnit 19 -255 -27 -170
SonarUnit 20 -255 27 170
SonarUnit 21 -237 78 150
SonarUnit 22 -203 119 130
SonarUnit 23 -157 136 90
...
LaserAutoConnect false   ; Laser_1 exists and should be automatically connected
                         ; at startup.
LaserX 17                ; Location (in mm) of the laser in X (+ front, - back)
                         ; relative to the robot's idealized center of
                         ; rotation.
LaserY 8                 ; Location (in mm) of the laser in Y (+ left, - right)
                         ; relative to the robot's idealized center of
                         ; rotation.
