...
Subclass amigo-sh-tim3xx ; specific type of robot
RobotRadius 180.00000    ; radius in mm
RobotDiagonal 120.00000  ; half-height to diagonal of octagon
RobotWidth 279.00000     ; width in mm
RobotLength 330.00000    ; length in mm of the whole robot
RobotLengthFront 160.00000 ; length in mm to the front of the robot (if this is
                         ; 0 (or non existent) this value will be set to half
                         ; of RobotLength)
RobotLengthRear 170.00000 ; length in mm to the rear of the robot (if this is 0
...
MaxVelocity 1000         ; absolute maximum mm / sec
...
SonarNum 8               ; Number of sonars on the robot.
...
SonarUnit 0 70 100 90
SonarUnit 1 125 75 41
SonarUnit 2 144 30 15
SonarUnit 3 144 -30 -15
SonarUnit 4 120 -75 -41
SonarUnit 5 70 -100 -90
SonarUnit 6 -146 -58 -145
SonarUnit 7 -146 58 145
...
LaserAutoConnect true    ; Laser_1 exists and should be automatically connected
                         ; at startup.
LaserX 110               ; Location (in mm) of the laser in X (+ front, - back)
...
LaserZ 200               ; minimum 0,  Height (in mm) of the laser from the
...
LaserType tim5XX         ; Type of laser.
LaserPortType tcp        ; Type of port the laser is on.
LaserPort 10.0.126.11:8102 ; Port the laser is on.
