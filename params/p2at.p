...
RobotRadius 500.00000    ; radius in mm
RobotDiagonal 120.00000  ; half-height to diagonal of octagon
RobotWidth 505.00000     ; width in mm
RobotLength 626.00000    ; length in mm of the whole robot
RobotLengthFront 313.00000 ; length in mm to the front of the robot (if this is
                         ; 0 (or non existent) this value will be set to half
                         ; of RobotLength)
RobotLengthRear 313.00000 ; length in mm to the rear of the robot (if this is 0
...
DistConvFactor 1.32000   ; multiplier to mm from robot units
VelConvFactor 1.00000    ; multiplier to mm/sec from robot units
RangeConvFactor 0.26800  ; multiplier to mm from sonar units
DiffConvFactor 0.00340   ; ratio of angular velocity to wheel velocity (unused
...
LaserAutoConnect false   ; Laser_1 exists and should be automatically connected
                         ; at startup.
LaserX 160               ; Location (in mm) of the laser in X (+ front, - back)
                         ; relative to the robot's idealized center of
                         ; rotation.
LaserY 7                 ; Location (in mm) of the laser in Y (+ left, - right)
                         ; relative to the robot's idealized center of
                         ; rotation.
