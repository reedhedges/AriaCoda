...
RobotRadius 833.00000    ; radius in mm
RobotDiagonal 400.00000  ; half-height to diagonal of octagon
RobotWidth 1270.00000    ; width in mm
RobotLength 1410.00000   ; length in mm of the whole robot
RobotLengthFront 705.00000 ; length in mm to the front of the robot (if this is
                         ; 0 (or non existent) this value will be set to half
                         ; of RobotLength)
RobotLengthRear 705.00000 ; length in mm to the rear of the robot (if this is 0
...
LaserAutoConnect true    ; Laser_1 exists and should be automatically connected
                         ; at startup.
LaserX 690               ; Location (in mm) of the laser in X (+ front, - back)
