...
Subclass peoplebot-sh-lms500 ; specific type of robot
...
PTZInverted true         ; If unit is mounted inverted (upside-down)
...
VideoInverted true       ; If image should be flipped (for cameras mounted
