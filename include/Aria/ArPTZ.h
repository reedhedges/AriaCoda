...
public:
  ...
  */
  ...
  /** The amount the camera is zoomed to (or last commanded value sent, 
    ...
    @sa canGetZoom()
  */
  AREXPORT virtual int getZoom() const { return 0; }
  ...
  virtual double getMaxPosPan() const { if (myInverted) return -myMaxPosPan; else return myMaxPosPan; }
  ...
  virtual double getMaxNegPan() const { if (myInverted) return -myMaxNegPan; else return myMaxNegPan; }
  ...
  virtual double getMaxPosTilt() const { if (myInverted) return -myMaxPosTilt; else return myMaxPosTilt; }
  ...
  virtual double getMaxNegTilt() const { if (myInverted) return -myMaxNegTilt; else return myMaxNegTilt; }
...
protected:
  ...
  //@{
  virtual double getMaxPosPan_i() const { return myMaxPosPan; }
  double getMaxPan_i() const { return getMaxPosPan_i(); }
  virtual double getMaxPosTilt_i() const { return myMaxPosTilt; }
  double getMinPan_i() const { return getMaxNegPan_i(); }
  virtual double getMaxNegPan_i() const { return myMaxNegPan; }
  double getMaxTilt_i() const { return getMaxPosTilt_i(); }
  virtual double getMaxNegTilt_i() const { return myMaxNegTilt; }
...
public:
  ...
  virtual int getMaxZoom() const { if (myInverted) return -myMaxZoom; else return myMaxZoom; }
  /// Gets the lowest value for the zoom on this camera
  virtual int getMinZoom() const { if (myInverted) return -myMinZoom; else return myMinZoom; }
  /// Whether we can get the FOV (field of view) or not
  virtual bool canGetFOV() { return false; }
  /// Gets the field of view at maximum zoom
  AREXPORT virtual double getFOVAtMaxZoom() { return 0; }
  /// Gets the field of view at minimum zoom
  AREXPORT virtual double getFOVAtMinZoom() { return 0; }
  ...
  AREXPORT virtual int getAuxPort() { return myAuxPort; }
   ...
   **/
  AREXPORT virtual ArBasePacket *readPacket() { return NULL; }
  ...
  **/
  ...
  AREXPORT virtual void sensorInterpHandler();
...
protected:
  ...
  AREXPORT virtual double getPan_i() const = 0;
  AREXPORT virtual double getTilt_i() const = 0;
  //@}
