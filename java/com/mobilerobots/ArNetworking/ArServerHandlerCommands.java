...
public class ArServerHandlerCommands {
  ...
  public void setTextServer(ArNetServer textServer) {
    ArNetworkingJavaJNI.ArServerHandlerCommands_setTextServer(swigCPtr, this, ArNetServer.getCPtr(textServer), textServer);
  }
