...
public class ArServerInfoDrawings {
  ...
  public ArDrawingData internalGetDrawingData(String name) {
    long cPtr = ArNetworkingJavaJNI.ArServerInfoDrawings_internalGetDrawingData(swigCPtr, this, name);
    return (cPtr == 0) ? null : new ArDrawingData(cPtr, false);
  }

  public ArFunctor_ServerData internalGetDrawingCallback(String name) {
    long cPtr = ArNetworkingJavaJNI.ArServerInfoDrawings_internalGetDrawingCallback(swigCPtr, this, name);
