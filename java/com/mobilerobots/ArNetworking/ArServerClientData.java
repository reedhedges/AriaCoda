...
public class ArServerClientData {
  ...
  public ArServerClientData(SWIGTYPE_p_ArServerData serverData, int mSecInterval, ArNetPacket packet) {
    this(ArNetworkingJavaJNI.new_ArServerClientData(SWIGTYPE_p_ArServerData.getCPtr(serverData), mSecInterval, ArNetPacket.getCPtr(packet), packet), true);
  }

  public SWIGTYPE_p_ArServerData getServerData() {
    long cPtr = ArNetworkingJavaJNI.ArServerClientData_getServerData(swigCPtr, this);
    return (cPtr == 0) ? null : new SWIGTYPE_p_ArServerData(cPtr, false);
  }
